                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($cart as $item) {
                                    ...
                                    $totalProducts = $totalProducts + $item['unit_price_orderdetails'] * $item['quantity_orderdetails'];
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=$information['name_city'] . ' - ' . $information['name_department']; ?></td>
                    ...
                    <div class="text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <img src="<?= base_url('pictures/peradk') ?>/twologo.png" alt="" class="img-fluid">
