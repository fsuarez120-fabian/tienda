...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url() . route_to('admin_page') ?>" class="brand-link elevation-4">
        <img src="<?= base_url() . route_to('images_peradk') ?>/logo_morado.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">PERA Colombia</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
