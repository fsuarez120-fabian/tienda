        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="text-center">
                    <p><b>Tiempo de producci&oacute;n de 2 d&iacute;as h&aacute;biles adicional el tiempo de env&iacute;o, por parte de la transportadora 🍐💖</b></p>
                    <b>PeRa Amiguis para tu comodidad tu env&iacute;o ser&aacute; despachado por</b>
                    <img src="<?php echo base_url('pictures/peradk'); ?>/servientrega.png" alt="" class="img-fluid col-7">
